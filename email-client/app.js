(function () {
  ...
  const els = {
    ...
    folderPane: document.querySelector("#folder-pane"), folderToggle: document.querySelector("#folder-toggle")
  };
  ...
  function setFolder(id) {
    ...
    els.folderPane.classList.remove("mobile-open");
    els.folderToggle.setAttribute("aria-expanded", "false");
    renderFolders(); renderList();
  }

  els.folderToggle.addEventListener("click", () => {
    const open = els.folderPane.classList.toggle("mobile-open");
    els.folderToggle.setAttribute("aria-expanded", String(open));
  });
