...
Status: describes the target state of the Cloudflare Workers + Durable Objects–backed phase (see ADR 0004 for phasing) — not yet implemented while the generator ships as URL-encoded, backend-free sharing.
